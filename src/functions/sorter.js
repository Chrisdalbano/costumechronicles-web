...
var sortedArticles = Array.from(productArticles).sort((a, b) => {
  ...
  return parseFloat(b.querySelector('b').innerText.slice(1)) - parseFloat(a.querySelector('b').innerText.slice(1));
  } else if (sortValue === 'price-low') {
  return parseFloat(a.querySelector('b').innerText.slice(1)) - parseFloat(b.querySelector('b').innerText.slice(1));
  } else {
  return 0;
  }
});
